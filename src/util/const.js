...
const appInstances = [
    { url: `http://localhost:${process.env.APP_INSTANCE_1_PORT}`, consecutiveFailureCount: 0, status: 'initial' },
    { url: `http://localhost:${process.env.APP_INSTANCE_2_PORT}`, consecutiveFailureCount: 0, status: 'initial' },
    { url: `http://localhost:${process.env.APP_INSTANCE_3_PORT}`, consecutiveFailureCount: 0, status: 'initial' },
  ];
